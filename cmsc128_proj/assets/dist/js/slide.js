//source: msdn.microsoft.com/en-ph/library/ie/hh920769(v=vs.85).aspx
...
function slideShow() {
  ...
  var globals = {
    slideDelay: 5500, // The time interval between consecutive slides.
    fadeDelay: 40, // The time interval between individual opacity changes. This should always be much smaller than slideDelay.  
    wrapperID: "sld", // The ID of the <div> element that contains all of the <img> elements to be shown as a slide show.
